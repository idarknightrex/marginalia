...
- **v0.9.2.2** — Dynamic local model discovery. Any model in `ollama list` auto-surfaces as a chip. No recoding needed to add new local models.
...
- v0.9.2.2 — Dynamic local model discovery ✓
