"""
Marginalia — app.py  v1.5.0.0628-1547
...
def handle_prompt():
    ...
    # If researcher injected synthesis as context, prepend it as a +++ layer
    # The bias warning was shown in the UI — this is the researcher's deliberate choice
    if synthesis_ctx:
...
if __name__ == "__main__":
    ...
    print(f"\n  Marginalia v1.5.0.0628-1547 running at http://localhost:{port}\n")
